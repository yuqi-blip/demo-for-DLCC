...
price_table = exact(Y_mesh, T_mesh, params['eta_1'], params['eta_2'])   # (N_y_grid, len(t))
...
for i, xi in enumerate(x):
    ...
    if xi > y_min:
        ...
        prob_left = prob_df(y_left - xi, params['eta_1'], params['eta_2'])              # (M,)
    ...
    if xi < y_max:
        ...
        prob_right = prob_df(y_right - xi, params['eta_1'], params['eta_2'])               # (M,)
...
np.save(f'gl_integral.npy', integral_GL)
print(f"  Saved gl_integral.npy")
